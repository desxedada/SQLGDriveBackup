...
#
# Created: Mon Nov 16 16:18:59 2020
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 80, 391, 95))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 300, 391, 51))
        ...
        QtCore.QObject.connect(self.connectionButton, QtCore.SIGNAL("clicked()"), self.connectionButton.click)
        QtCore.QObject.connect(self.okButton, QtCore.SIGNAL("clicked()"), self.okButton.click)
        QtCore.QObject.connect(self.backupButton, QtCore.SIGNAL("clicked()"), self.backupButton.click)
        QtCore.QObject.connect(self.instanceBox, QtCore.SIGNAL("activated(QString)"), self.instanceBox.setCurrentText)
